...
class CustomSpinKitWaveSpinner extends StatefulWidget {
  ...
  @override
  State<CustomSpinKitWaveSpinner> createState() => _CustomSpinKitWaveSpinnerState();
}

class _CustomSpinKitWaveSpinnerState extends State<CustomSpinKitWaveSpinner> with SingleTickerProviderStateMixin {
...
class SpinkitWaveCustomPaint extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final spinnerMaxWidth = math.max(3.0, size.width * 0.045);
    _drawArc(
      size,
      canvas,
      color: trackColor,
  ...
  double _lineRadius(double width, double multiplier) {
    return (width - (multiplier * math.max(1.5, width * 0.015))) / 2;
  }
