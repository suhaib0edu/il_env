...
""";
  ...
  String overallEvaluationPrompt(int score,List<Question> questions, String lesson) => '''
...
قم بتقديم تقييم الطالب بناءً على درجته في الاختبار.  الدرجة هي: $score.
...
ستخاطب الطالب في ردك و الذي سيكون
تقييم شامل للطالب 
معدل الطالب او الدرجة التي احرزها
الاجابات الصحيحة
الاجابات الخطاء
...
قم بتوليد بطاقات حفظ (Flashcards) بناءً على محتوى الدرس التالي:
